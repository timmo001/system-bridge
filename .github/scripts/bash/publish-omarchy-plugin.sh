...
required=(BarWidget.qml FilterablePanel.qml Panel.qml README.md SectionHeading.qml Service.qml manifest.json screenshot.png)
...
expected_source=(BarWidget.qml FilterablePanel.qml Panel.qml README.md SectionHeading.qml Service.qml manifest.json screenshot.png)
...
expected_publish=(BarWidget.qml FilterablePanel.qml LICENSE Panel.qml README.md SectionHeading.qml Service.qml manifest.json screenshot.png)
