...
Build everything (web client and backend binary):
...
| `mise run run:backend-dev` | Build and run the backend with console output |
...
| `mise run lint:all` | Go fmt/vet, web-client ESLint/typecheck |
