...
func (h *MessageHandler) RegisterUpdateSettingsHandler() {
	h.router.RegisterSimpleHandler(event.EventUpdateSettings, func(message event.Message) event.MessageResponse {
