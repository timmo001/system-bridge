...
func (h *MessageHandler) RegisterKeyboardTextHandler() {
	h.router.RegisterSimpleHandler(event.EventKeyboardText, func(message event.Message) event.MessageResponse {
